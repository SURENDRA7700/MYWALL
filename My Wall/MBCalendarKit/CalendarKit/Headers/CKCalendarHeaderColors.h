...
#define kCalendarColorHeaderWeekdayTitle    [UIColor colorWithRed:1 green:1 blue:1 alpha:1.0]
#define kCalendarColorHeaderMonth           [UIColor colorWithRed:1 green:1 blue:1 alpha:1.0]
#define kCalendarColorHeaderGradientDark    [UIColor colorWithRed: 0.15 green: 0.20 blue: 0.22 alpha: 1.00]
