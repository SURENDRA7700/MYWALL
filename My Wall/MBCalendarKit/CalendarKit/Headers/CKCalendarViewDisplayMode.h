...
typedef NS_ENUM(NSUInteger, CKCalendarViewDisplayMode) {
    CKCalendarViewDisplayModeMonth = 2,
    CKCalendarViewDisplayModeWeek = 1,
    CKCalendarViewDisplayModeDay = 0,
    CKCalendarViewModeMonth __deprecated_enum_msg("Use CKCalendarViewDisplayModeMonth instead.") = 2,
    CKCalendarViewModeWeek __deprecated_enum_msg("Use CKCalendarViewDisplayModeWeek instead.") = 1,
    CKCalendarViewModeDay __deprecated_enum_msg("Use CKCalendarViewDisplayModeDay instead.") = 0
