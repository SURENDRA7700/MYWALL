...
extension UIColor {
    ...
    struct MyWall {
        ...
        static let appColor : UIColor = #colorLiteral(red: 0.1529411765, green: 0.1960784314, blue: 0.2196078431, alpha: 1)
        static let LightBlue : UIColor = #colorLiteral(red: 0.2039215686, green: 0.6509803922, blue: 0.6941176471, alpha: 1)
//        static let appColor : UIColor = #colorLiteral(red: 0.2039215686, green: 0.6509803922, blue: 0.6941176471, alpha: 1)
        ...
        static let lightBlack : UIColor = #colorLiteral(red: 0.9215686275, green: 0.9215686275, blue: 0.9215686275, alpha: 1)
...
extension UIColor {
    ...
    static let primaryColor : UIColor = #colorLiteral(red: 0, green: 0.2890734375, blue: 0.4606239796, alpha: 1)
    static let appColor : UIColor = #colorLiteral(red: 0.1529411765, green: 0.1960784314, blue: 0.2196078431, alpha: 1)
//    static let appColor : UIColor = #colorLiteral(red: 0.2039215686, green: 0.6509803922, blue: 0.6941176471, alpha: 1)

    static let darkColor : UIColor = #colorLiteral(red: 0, green: 0, blue: 0, alpha: 1)
    static let disabledColor : UIColor = #colorLiteral(red: 0.4703553319, green: 0.5181970596, blue: 0.6206259131, alpha: 1)
    static let shadowColor : UIColor = #colorLiteral(red: 0.6783706546, green: 0.6784701943, blue: 0.6783489585, alpha: 1)
    static let menuTextColor : UIColor = #colorLiteral(red: 0.4862297773, green: 0.4863032103, blue: 0.4862136245, alpha: 1)
    static let disabledGrayColor : UIColor = #colorLiteral(red: 0.9332516193, green: 0.9333856702, blue: 0.9332222342, alpha: 1)
